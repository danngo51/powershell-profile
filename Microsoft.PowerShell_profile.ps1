...
############                       https://github.com/danngo51/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
...
function Update-Profile {
    ...
    try {
        Write-Host "Pulling Profile..." -ForegroundColor Cyan
        ...
        if ($newhash.Hash -ne $oldhash.Hash) {
            ...
            Write-Host "Profile already up to date." -ForegroundColor Green
        }
    } catch {
...
function Get-Theme {
    if (-not $global:canConnectToGitHub) {
        ...
        oh-my-posh init pwsh --config "C:\Users\danng\Documents\PowerShell\Themes\default.omp.json" | Invoke-Expression
